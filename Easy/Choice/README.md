<h2><a href="https://www.geeksforgeeks.org/problems/choice/1?page=5&difficulty=Basic,Easy&status=unsolved&sortBy=submissions">Choice</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Geek&nbsp;played three matches and he wants to represent his scores as an array and in the Concatenated&nbsp;string form.</span></p>
