<h2><a href="https://www.geeksforgeeks.org/problems/sum-equals-to-sum4006/1?page=3&category=Arrays,Strings&difficulty=Easy&status=unsolved&sortBy=difficulty">Sum equals to Sum</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given an array <strong>A</strong> of <strong>N</strong>&nbsp;integers. The task is to find if there are two pairs (a, b) and (c, d) such that a+b = c+d.</span></p>
