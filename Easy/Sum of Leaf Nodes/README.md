<h2><a href="https://www.geeksforgeeks.org/problems/sum-of-leaf-nodes/1?page=2&category=Tree&difficulty=Easy&status=unsolved&sortBy=submissions">Sum of Leaf Nodes</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a Binary Tree of size&nbsp;<strong>N</strong>. The task is to complete the function&nbsp;<strong>sumLeaf()</strong>, that should return the sum of all the leaf nodes of the given binary tree.</span></p>
