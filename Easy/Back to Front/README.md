<h2><a href="https://www.geeksforgeeks.org/problems/back-to-front/1?page=5&difficulty=Easy&status=unsolved&sortBy=submissions">Back to Front</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a <strong>vector </strong>of <strong>N</strong> positive integers. Your task is to print the vector elements in <strong>reverse </strong>order.</span></p>
