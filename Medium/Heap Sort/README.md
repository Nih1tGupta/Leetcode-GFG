<h2><a href="https://www.geeksforgeeks.org/problems/heap-sort/1?page=3&difficulty=Easy,Medium&status=unsolved&sprint=94ade6723438d94ecf0c00c3937dad55&sortBy=submissions">Heap Sort</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given an array of size N. The task is to sort the array elements by completing functions <strong>heapify</strong>() and <strong>buildHeap</strong>() which are used to implement Heap Sort.</span></p>
