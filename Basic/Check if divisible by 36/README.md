<h2><a href="https://www.geeksforgeeks.org/problems/check-if-divisible-by-363149/1?page=7&difficulty=Basic,Easy&sortBy=submissions">Check if divisible by 36</a></h2><h3>Difficulty Level : Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a number S in the form of string, the task is to find if it's divisible&nbsp;by 36&nbsp;or not.&nbsp;</span></p>
