<h2><a href="https://www.geeksforgeeks.org/problems/repeated-sum-of-digits3955/1?page=6&difficulty=Basic,Easy&status=unsolved&sortBy=submissions">Repeated sum of digits</a></h2><h3>Difficulty Level : Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given an integer N, recursively sum digits of N until we get a single digit.&nbsp; The process can be described below</span></p>
