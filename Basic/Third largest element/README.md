<h2><a href="https://www.geeksforgeeks.org/problems/third-largest-element/1?page=3&category=Arrays&difficulty=Basic,Easy&status=solved&sortBy=submissions">Third largest element</a></h2><h3>Difficulty Level : Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given an array of distinct elements. Find the third largest element in it. </span></p>
