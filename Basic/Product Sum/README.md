<h2><a href="https://www.geeksforgeeks.org/problems/product-sum3012/1?page=2&category=Sorting,Numbers,number-theory,Map,set&difficulty=Easy&status=unsolved&sortBy=submissions">Product Sum</a></h2><h3>Difficulty Level : Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given two integers&nbsp;a&nbsp;and&nbsp;b. Write a program to find the number of digits in the product of these two integers.</span><br>
<br>
