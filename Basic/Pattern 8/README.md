<h2><a href="https://www.geeksforgeeks.org/problems/triangle-pattern-1661493231/1?page=1&difficulty=Basic&status=unsolved&sortBy=submissions">Pattern 8</a></h2><h3>Difficulty Level : Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Geek is very fond of patterns. Once, his teacher gave him a&nbsp;&nbsp;pattern to solve. He gave Geek&nbsp;an integer n and asked him to build a pattern.</span></p>
