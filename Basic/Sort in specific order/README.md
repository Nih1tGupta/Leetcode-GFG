<h2><a href="https://www.geeksforgeeks.org/problems/sort-in-specific-order2422/1?page=1&category=Sorting,Hash,Linked%20List,Recursion,Binary%20Search&difficulty=Basic&status=unsolved&sortBy=submissions">Sort in specific order</a></h2><h3>Difficulty Level : Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given an array <strong>A</strong> of positive integers. Your task is to sort them in such a way that the first part of the array contains odd numbers sorted in descending order, rest portion contains even numbers sorted in ascending order.</span></p>
