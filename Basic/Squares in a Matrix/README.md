<h2><a href="https://www.geeksforgeeks.org/problems/squares-in-a-matrix5716/1?page=3&difficulty=Basic&status=unsolved&sortBy=submissions">Squares in a Matrix</a></h2><h3>Difficulty Level : Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a <strong>mxn</strong> matrix, count the number of squares in the matrix. </span></p>
